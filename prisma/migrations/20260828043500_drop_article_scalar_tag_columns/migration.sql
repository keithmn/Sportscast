/*
  ...
  - You are about to drop the column `clubId` on the `Article` table. All the data in the column will be lost.
  - You are about to drop the column `competitionId` on the `Article` table. All the data in the column will be lost.
  - You are about to drop the column `playerId` on the `Article` table. All the data in the column will be lost.
