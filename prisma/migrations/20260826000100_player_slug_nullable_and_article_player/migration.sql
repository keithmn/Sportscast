...
CREATE TABLE "new_Article" (
    ...
    CONSTRAINT "Article_playerId_fkey" FOREIGN KEY ("playerId") REFERENCES "Player" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Article" ("authorId", "body", "clubId", "competitionId", "contentType", "coverImageUrl", "createdAt", "dek", "episodeLabel", "featured", "id", "isBrief", "publishedAt", "runtimeLabel", "slug", "sportId", "status", "title", "updatedAt", "videoSeries", "youtubeId") SELECT "authorId", "body", "clubId", "competitionId", "contentType", "coverImageUrl", "createdAt", "dek", "episodeLabel", "featured", "id", "isBrief", "publishedAt", "runtimeLabel", "slug", "sportId", "status", "title", "updatedAt", "videoSeries", "youtubeId" FROM "Article";
DROP TABLE "Article";
